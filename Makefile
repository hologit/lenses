...
.PHONY: all _base-image k8s-normalize helm3 kustomize mkdocs npm-install npm-run

all: _base-image k8s-normalize helm3 kustomize mkdocs npm-install npm-run
